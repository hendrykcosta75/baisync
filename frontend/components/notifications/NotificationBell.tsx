...
export function NotificationBell() {
  ...
  return (
    ...
    <Dropdown isOpen={dropdownOpen} onOpenChange={setDropdownOpen}>
      <Dropdown.Trigger>
        <div role="button" tabIndex={0} className="relative inline-flex items-center justify-center w-9 h-9 rounded-lg text-subtle hover:bg-raised/80 cursor-pointer transition-colors" aria-label="Notificações">
