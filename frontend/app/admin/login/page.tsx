...
export default function AdminLoginPage() {
  ...
  const { adminLogin, isLoading, error, clearError, isAuthenticated } = useAdminStore()
    ...
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          <Label style={{ fontFamily: mono, fontSize: 11, color: '#888', letterSpacing: 1, textTransform: 'uppercase' as const }}>Usuario</Label>
          <Input
            autoFocus
