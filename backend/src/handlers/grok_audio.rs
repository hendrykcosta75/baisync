...
use crate::services::grok_audio::{GROK_FORMAT_MP3, GROK_VOICES};
...
pub async fn preview_voice(
    ...
    let audio_bytes =
        crate::services::grok_audio::text_to_speech(&api_key, &body.voice_id, &text, GROK_FORMAT_MP3)
            .await?;
